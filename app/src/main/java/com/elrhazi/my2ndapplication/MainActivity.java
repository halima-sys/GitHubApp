package com.elrhazi.my2ndapplication;
...
import com.elrhazi.my2ndapplication.model.GitUser;
import com.elrhazi.my2ndapplication.model.GitUsersResponse;
import com.elrhazi.my2ndapplication.model.UsersListViewModel;
import com.elrhazi.my2ndapplication.service.GitRepoServiceAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int postion, long id) {
                String login=data.get(postion).login;
